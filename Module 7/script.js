...
let products = [
  {
    id: 2233, name: "T-shirt", priceHT: 35,  description: "T-shirt incoyable !",  image: "https://images.unsplash.com/photo-1561347981-969c80cf4463?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
  },

  {
    id: 7799, name: "Mug", priceHT: 20, description: "Mug incoyable !", image: "https://i.etsystatic.com/19277706/r/il/37dc90/2164600026/il_570xN.2164600026_2jzc.jpg"
  },

  {
    id: 1509, name: "Tapis de souris", priceHT: 80, description: "Tapis de souris pas cher !", image: "https://m.media-amazon.com/images/I/81GTmKhKzQL.jpg"
  }
]

const productListt = document.getElementById("product-list");

function createProductCard(product) {
  

    const contentCard = document.createElement("article");
     contentCard.classList.add("product-card");
    ...
    const priceElt = document.createElement("p");
    priceElt.innerHTML = formatPrice(calculatePriceTTC(product.priceHT));
    priceElt.classList.add("product-price");
    ...
    contentCard.appendChild(priceElt);
